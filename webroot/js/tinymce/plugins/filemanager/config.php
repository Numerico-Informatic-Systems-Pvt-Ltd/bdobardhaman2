...
$base_url="http://www.bdobardhaman2.org"; 
$upload_dir = '/webroot/images/'; // path from base_url to upload base dir
$current_path = '../../../../../webroot/images/'; // relative path from filemanager folder to upload files folder
