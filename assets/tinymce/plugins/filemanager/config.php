...
/* $base_url="http://http://bdobardhaman2.org"; //url base of site if you want only relative url leave empty */
$base_url="http://bdobardhaman2.org"; 
$upload_dir = '/bdobardhaman/assets/images/';// path from base_url to upload base dir
