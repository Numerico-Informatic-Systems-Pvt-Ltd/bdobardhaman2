                        ...
                        <tbody>
                            ...
                            foreach ($results as $data) {
                                ...
                                <tr>
                                    ...
                                    <td><a role="button" class="btn btn-primary btn-xs" href="<?php echo base_url() . index_page(); ?>/admin/staffdirectory/edit/<?php echo $data->id; ?>">Edit</a></td>
                                    <td><a role="button" class="btn btn-danger btn-xs" href="<?php echo base_url() . index_page(); ?>/admin/staffdirectory/delete/<?php echo $data->id; ?>">Delete</a></td>
                                </tr>
                                <?php
                            }
                            ?>
