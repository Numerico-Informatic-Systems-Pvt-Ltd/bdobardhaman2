                                ...
                                <div class="panel-body">
                                    <form method="POST" class="form form-vertical" enctype="multipart/form-data">
                                        ...
                                        <div class="control-group">
                                            ...
                                            <div class="controls">
                                                <textarea name="txt_page_content" style="height: 500px;" class="form-control" placeholder="Enter Description"></textarea>
                                            </div>
                                        </div> 
                                        <div class="control-group">
                                            <label></label>
                        ...
                        <tbody>
                            ...
                            foreach ($results as $data) {
                                ...
                                <tr>
                                    ...
                                    <td><a role="button" class="btn btn-primary btn-xs" href="<?php echo base_url() . index_page(); ?>/admin/bulletins/edit/<?php echo $data->id; ?>">Edit</a></td>
                                    <td><a role="button" class="btn btn-danger btn-xs" href="<?php echo base_url() . index_page(); ?>/admin/bulletins/delete/<?php echo $data->id; ?>">Delete</a></td>
                                </tr>
                                <?php
                            }
                            ?>
