                        ...
                        <tbody>
                            ...
                            foreach ($results as $k => $v) {
                                ...
                                <tr>
                                    ...
                                    <td><a role="button" class="btn btn-primary btn-xs" href="<?php echo base_url() . index_page(); ?>/admin/bottommenu/edit/<?php echo $results[$k]['id']; ?>">Edit</a></td>
                                    <?php
                                    if (!isset($results[$k]['child'])) { ?>
                                      <td><a role="button" class="btn btn-danger btn-xs" href="<?php echo base_url() . index_page(); ?>/admin/bottommenu/delete/<?php echo $results[$k]['id']; ?>">Delete</a></td>  
                                ...
                                if (isset($results[$k]['child'])) {
                                    foreach ($results[$k]['child'] as $key => $value) {
                                        ...
                                        <tr>
                                            ...
                                            <td><a role="button" class="btn btn-primary btn-xs" href="<?php echo base_url() . index_page(); ?>/admin/bottommenu/edit/<?php echo $results[$k]['child'][$key]['id']; ?>">Edit</a></td>
                                            <?php
                                            if (!isset($results[$k]['child'][$key]['child'])) { ?>
                                              <td><a role="button" class="btn btn-danger btn-xs" href="<?php echo base_url() . index_page(); ?>/admin/bottommenu/delete/<?php echo $results[$k]['child'][$key]['id']; ?>">Delete</a></td>  
                                        ...
                                        if (isset($results[$k]['child'][$key]['child'])) {
                                            foreach ($results[$k]['child'][$key]['child'] as $_k => $_v) {
                                                ...
                                                <tr>
                                                    ...
                                                    <td><a role="button" class="btn btn-primary btn-xs" href="<?php echo base_url() . index_page(); ?>/admin/bottommenu/edit/<?php echo $results[$k]['child'][$key]['child'][$_k]['id']; ?>">Edit</a></td>
                                                    <td><a role="button" class="btn btn-danger btn-xs" href="<?php echo base_url() . index_page(); ?>/admin/bottommenu/delete/<?php echo $results[$k]['child'][$key]['child'][$_k]['id']; ?>">Delete</a></td>
                                                </tr>
                                                <?php
                                            }
                                        }
