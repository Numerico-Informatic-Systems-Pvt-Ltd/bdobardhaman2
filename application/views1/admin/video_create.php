                                ...
                                <div class="panel-body">
                                    <form method="POST" class="form form-vertical">
                                        ...
                                        <div class="control-group">
                                            ...
                                            <div class="controls">
                                                <input name="txt_page_link" type="text" class="form-control" placeholder="Enter Link">
                                            </div>
                                        </div>
                                        <div class="control-group">
                                            <label>Video Content</label>
                                            <div class="controls">
                                                <textarea name="txt_page_content" style="height: 500px;" class="form-control" placeholder="Enter Content"></textarea>
                                            </div>
                                        </div> 
                                        <div class="control-group">
                                            <label></label>
                        ...
                        <tbody>
                            ...
                            foreach ($results as $data) {
                                ...
                                <tr>
                                    ...
                                    <td><a role="button" class="btn btn-primary btn-xs" href="<?php echo base_url() . index_page(); ?>/admin/videos/edit/<?php echo $data->id; ?>">Edit</a></td>
                                    <td><a role="button" class="btn btn-danger btn-xs" href="<?php echo base_url() . index_page(); ?>/admin/videos/delete/<?php echo $data->id; ?>">Delete</a></td>
                                </tr>
                                <?php
                            }
                            ?>
