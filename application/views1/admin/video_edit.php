                                ...
                                <div class="panel-body">
                                    <form method="POST" class="form form-vertical">
                                        <div class="control-group">
                                            ...
                                            <div class="controls">
                                                <input name="video_link" type="text" class="form-control" placeholder="Enter Name" value="<?php echo $results->link ?>">
                                            </div>
                                        </div>
                                        <div class="control-group">
                                            <label>Video Content</label>
                                            <div class="controls">
                                                <textarea name="video_content" style="height: 500px;"  class="form-control" placeholder="Enter Content">
