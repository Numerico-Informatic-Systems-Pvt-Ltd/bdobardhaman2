                                ...
                                <div class="panel-body">
                                    <form method="post" enctype="multipart/form-data" action="">
                                        <div class="control-group">
                                            ...
                                            <div class="controls">
                                                <select name="slct_gallery" class="form-control">
                                                    <option value="<?php echo !empty($image_info->link) ? $image_info->link: 0; ?>"><?php echo !empty($image_info->link) ? $image_info->link: 'select page'; ?></option>
                                                    <?php
                                        ...
                                        <div class="control-group">
                                            ...
                                            <div class="controls">
                                                <img src="<?php echo !empty($image_info->image) ? base_url().'assets/images/'.$image_info->image: ''; ?>" alt="<?php echo ($image_info->image)?$image_info->image:'';?>" height="150">
                                        ...
                                        <div class="control-group">
                                            <label>msg</label>
                                            <div class="controls">
                                                <input name="txt_msg" type="text" class="form-control" value="<?php echo !empty($image_info->msg)?$image_info->msg:''; ?>">
                                            </div>
                                        </div>
                                        <div class="control-group">
                                            <label></label>
