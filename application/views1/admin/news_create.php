                            ...
                            <div class="panel panel-default">
                                ...
                                <div class="panel-body">
                                    <form method="POST" class="form form-vertical">
                                        ...
                                        ?>
                                        <div class="control-group">
                                            <label>Tab <?= $i; ?> Name</label>
                                            <div class="controls">
                                                <input name = <?= "txt_page_title_".$i; ?> type="text" class="form-control" placeholder="Enter Name">
                                            </div>
                                        </div>
                                        <div class="control-group">
                                            <label>Tab <?= $i; ?> Content</label>
                                            <div class="controls">
                                                <textarea name= <?= "txt_page_content_".$i; ?>  style="height:500px;" class="form-control" placeholder="Enter Description"></textarea>
                                            </div>
                                        </div>
                                        <?php
                                        }
                        ...
                        <tbody>
                            ...
                            foreach ($results as $data) {
                                ...
                                <tr>
                                    ...
                                    <td><a role="button" class="btn btn-primary btn-xs" href="<?php echo base_url() . index_page(); ?>/admin/news/edit/<?php echo $data->header; ?>/<?php echo $data->news_id; ?>">Edit</a></td>
                                    <td><a role="button" class="btn btn-danger btn-xs" href="<?php echo base_url() . index_page(); ?>/admin/news/delete/<?php echo $data->news_id; ?>">Delete</a></td>
                                </tr>
                                <?php
                            }
                            ?>
